<div class="modal fade" id="edit-producto" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                  ...
                  <form data-toggle="validator" action="/item-ajax/14" method="put">
                     ...
                     <div class="form-group">
                        <button type="submit" class="btn btn-success crud-producto-edit">Guardar</button>
                     </div>
                  </form>
